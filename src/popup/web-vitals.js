      ...
      (n = n || {}),
        L(function () {
          var t,
            ...
            o = function (e) {
              ...
              n &&
                ...
                ((i.value = Math.max(n.startTime - s(), 0)),
                (i.entries = [n]),
                t());
            },
          ...
          if (a) {
            ...
            var u = m(function () {
              W[i.id] ||
                (o(a.takeRecords()), a.disconnect(), (W[i.id] = !0), t(!0));
            });
...
//export const { onCLS, onFID, onLCP } = webVitals;
